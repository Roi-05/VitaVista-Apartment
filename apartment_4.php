...
session_start();
$pricePerNight = 18000; // Set the price for the specific apartment
?>
...
<head>
  ...
  <title>PentHouse Apartment</title>
...
<div class="room-details-container">
  ...
  <section id="pricing">
    <h2>Pricing</h2>
    <p><strong>Rental Price:</strong> Php 189,000/month &#8369;</p>
...
<div class="booking-section" data-price-per-night="18000">
...
<div id="payment-modal" class="modal">
  ...
  <script>
    ...
    <script>
  const pricePerNight = 18000; // Price specific to this apartment
</script>
