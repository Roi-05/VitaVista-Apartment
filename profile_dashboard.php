  ...
  <div class="card">
    ...
    if (empty($bookings)) {
        ...
        foreach ($bookings as $booking) {
            echo "<li style='margin-bottom: 20px; padding-bottom: 10px; border-bottom: 1px solid #ccc;'>";
            echo "<strong>Apartment:</strong> {$booking['apartment_type']} ({$booking['unit']})<br>";
            echo "<strong>Check-in:</strong> " . date('F j, Y', strtotime($booking['check_in_date'])) . "<br>";
            echo "<strong>Check-out:</strong> " . date('F j, Y', strtotime($booking['check_out_date'])) . "<br>";
            echo "<strong>Total Price:</strong> ₱" . number_format($booking['total_price'], 2) . "<br>";
            echo "<strong>Booked On:</strong> " . date('F j, Y g:i A', strtotime($booking['created_at']));
            echo "</li>";
        }
        echo "</ul>";
    }
